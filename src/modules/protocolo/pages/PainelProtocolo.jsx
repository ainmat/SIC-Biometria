...
function KpiCard({ icon: Icon, label, value, cor = '#0D7C3D', sub }) {
  return (
    <div style={{ flex: 1, minWidth: '220px', background: 'linear-gradient(160deg, rgba(0, 0, 0, 0.02) 0%, rgba(0,0,0,.015) 100%)', border: '1px solid rgba(0, 0, 0, 0.05)', borderTop: `3px solid ${cor}`, borderRadius: 14, padding: '18px 20px' }}>
      ...
      <div style={{ fontSize: 32, fontWeight: 800, color: 'var(--text)', lineHeight: 1 }}>{fmt(value)}</div>
