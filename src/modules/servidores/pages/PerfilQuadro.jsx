          ...
          <>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 20 }}>
              {[
                ...
                <button key={id} onClick={() => setAba(id)} style={{ padding: '8px 18px', borderRadius: 8, background: aba === id ? 'rgba(99,102,241,.2)' : 'rgba(255,255,255,.03)', border: `1px solid ${aba === id ? 'rgba(99,102,241,.5)' : 'rgba(255,255,255,.08)'}`, color: aba === id ? '#a5b4fc' : '#64748b', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
                  {label}
                </button>
              ))}
            </div>
                ...
                <div style={{ display: 'flex', gap: 14, marginBottom: 20, flexWrap: 'wrap' }}>
                  ...
                  <div style={{ flex: 1, minWidth: 200, padding: '16px 18px', borderRadius: 12, background: 'rgba(255,255,255,.02)', border: '1px solid rgba(255,255,255,.07)' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                      {[
                        { label: 'Quadro geral',  pctF: equidade.geral.pctF,     cor: '#94a3b8' },
                ...
                <div className="chart-card">
                  ...
                  <ResponsiveContainer width="100%" height={equidade.porSecretaria.length * 32 + 20}>
                    <BarChart data={equidade.porSecretaria} layout="vertical" margin={{ left: 8, right: 60, top: 0, bottom: 0 }}>
                      ...
                      <Tooltip content={<TooltipGenero />} cursor={{ fill: 'rgba(255,255,255,.04)' }} />
                  ...
                  <div style={{ display: 'flex', gap: 14, marginTop: 10 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                      ...
                      <span style={{ fontSize: 10, color: '#64748b' }}>Acima da média geral ({equidade.geral.pctF.toFixed(0)}%)</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 14, marginBottom: 20, flexWrap: 'wrap' }}>
                  {[
                    ...
                    { label: 'Média em anos normais',    val: fmt(ondas.mediaNormal),  sub: `por ano (${ondas.nNormalAnos} anos)`,  cor: '#6366f1' },
                ...
                <div className="chart-card">
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <BarChart data={chartOndas} margin={{ left: 0, right: 20, top: 4, bottom: 20 }}>
                      ...
                      <Tooltip content={<TooltipOndas />} cursor={{ fill: 'rgba(255,255,255,.04)' }} />
                      <Bar dataKey="count" maxBarSize={32} radius={[3, 3, 0, 0]}>
                        {chartOndas.map((d, i) => <Cell key={i} fill={d.eleicao ? '#f59e0b' : '#6366f1'} />)}
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                  {!decada && (
