// icon-bar — componente de toolbar animada com framer-motion
  ...
  return (
    <motion.button
      ...
      <motion.div
        ...
        <span
          className="block whitespace-nowrap pr-3 font-medium text-[14px] tracking-[-0.01em]">
          {label}
        </span>
      </motion.div>
      <span
